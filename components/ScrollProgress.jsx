...
export default function ScrollProgress() {
  ...
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none w-[300px] max-w-[calc(100vw-32px)]"
    >
      <div
        className="flex items-center justify-between gap-2 rounded-full border border-white/15 bg-[rgba(8,9,11,0.72)] px-3 py-2.5 shadow-[0_8px_24px_rgba(0,0,0,0.35)] backdrop-blur-md"
      >
